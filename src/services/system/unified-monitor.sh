...
JESTEROS_CONFIG="${JESTEROS_CONFIG:-/src/services/config/jesteros.conf}"
[ -f "$JESTEROS_CONFIG" ] && source "$JESTEROS_CONFIG"

# Source consolidated functions
CONSOLIDATED_FUNCTIONS="${CONSOLIDATED_FUNCTIONS:-/src/services/system/consolidated-functions.sh}"
[ -f "$CONSOLIDATED_FUNCTIONS" ] && source "$CONSOLIDATED_FUNCTIONS"

# Source memory configuration
MEMORY_CONFIG="${MEMORY_CONFIG:-/src/services/config/memory.conf}"
