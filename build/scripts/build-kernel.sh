...
mkdir -p firmware/kernel/modules
mkdir -p firmware/boot

if [ -f "$KERNEL_DIR/src/arch/arm/boot/uImage" ]; then
    cp "$KERNEL_DIR/src/arch/arm/boot/uImage" firmware/kernel/
    cp "$KERNEL_DIR/src/arch/arm/boot/uImage" firmware/boot/
    echo "  ✓ Kernel image: firmware/kernel/uImage"
fi

# If SquireOS was built as a module, copy it
if [ -f "$KERNEL_DIR/src/drivers/squireos/squireos.ko" ]; then
    cp "$KERNEL_DIR/src/drivers/squireos/squireos.ko" firmware/kernel/modules/
    echo "  ✓ SquireOS module: firmware/kernel/modules/squireos.ko"
fi
