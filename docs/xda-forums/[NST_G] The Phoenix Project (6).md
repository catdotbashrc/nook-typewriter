...
source: "https://xdaforums.com/t/nst-g-the-phoenix-project.4673934/page-7"
author:
  - "[[nmyshkin]]"
...
> [hassanraza100 said:](https://xdaforums.com/goto/post?id=90064675)
> 
...
The best battery life is Phase 1.  
सबसे अच्छा बैटरी जीवन चरण 1 है।  
  
With Phase 1 you can only read languages like Hindi or Urdu as PDF.  
चरण 1 में आप केवल हिंदी या उर्दू जैसी भाषाओं को ही पीडीएफ के रूप में पढ़ सकते हैं।  
  
Most PDFs do not display well on the Phase 1 NST.  
अधिकांश पीडीएफ चरण 1 एनएसटी पर अच्छी तरह से प्रदर्शित नहीं होते हैं।  
  
Phase 3 is the most versatile. I am now working on a version for right-to-left languages.  
चरण 3 सबसे बहुमुखी है। मैं अब दाएं से बाएं भाषाओं के लिए एक संस्करण पर काम कर रहा हूं।  
  
If your battery life is short, it may just be too old. Many people have replaced their batteries.  
अगर आपकी बैटरी की लाइफ कम है, तो हो सकता है कि वह बहुत पुरानी हो गई हो। बहुत से लोगों ने अपनी बैटरी बदल ली है।  
  
There could also be a hardware problem.  
इसमें हार्डवेयर समस्या भी हो सकती है.  
  
You can install any build in any order at any time from any Phase.  
आप किसी भी चरण से किसी भी समय किसी भी क्रम में कोई भी बिल्ड स्थापित कर सकते हैं।

#### hassanraza100

##### Member

> [nmyshkin said:](https://xdaforums.com/goto/post?id=90064942)
> 
> The best battery life is Phase 1.  
> सबसे अच्छा बैटरी जीवन चरण 1 है।  
>   
...
Air thanks very much my exams are going till 7 may will the RTL (right to left language) version be available by then. And sir the issue with the SD card when I remove my SD card the nook works fine but when I plug as card it keeps lagging

#### nmyshkin

##### Recognized Contributor

> [hassanraza100 said:](https://xdaforums.com/goto/post?id=90065286)
> 
> Air thanks very much my exams are going till 7 may will the RTL (right to left language) version be available by then. And sir the issue with the SD card when I remove my SD card the nook works fine but when I plug as card it keeps lagging
> 
> Click to expand...
...
The RTL build will be done when it is done. I can't give a date. I don't want to post something that is full of bugs.  
RTL का निर्माण तब किया जाएगा जब यह पूरा हो जाएगा। मैं कोई तारीख नहीं बता सकता। मैं कुछ ऐसा पोस्ट नहीं करना चाहता जो बग से भरा हो।  
  
It is not normal for the sdcard to slow down the device.  
एसडी कार्ड के कारण डिवाइस का धीमा हो जाना सामान्य बात नहीं है।  
  
If you are using a Phase 2 or 3 build, it is important to copy the contents of the sdcard that were in the download zip. Those files are needed for the device to run properly.  
यदि आप चरण 2 या 3 बिल्ड का उपयोग कर रहे हैं, तो डाउनलोड ज़िप में मौजूद एसडी कार्ड की सामग्री को कॉपी करना महत्वपूर्ण है। डिवाइस को ठीक से चलाने के लिए उन फ़ाइलों की आवश्यकता होती है।  
  
If you did that and there is still a problem, either the card may be defective or the hardware itself may have a problem.  
यदि आपने ऐसा किया और फिर भी समस्या बनी रहती है, तो या तो कार्ड ख़राब हो सकता है या हार्डवेयर में ही कोई समस्या हो सकती है।

#### hassanraza100

##### Member

> [nmyshkin said:](https://xdaforums.com/goto/post?id=90066309)
> 
> The RTL build will be done when it is done. I can't give a date. I don't want to post something that is full of bugs.  
> RTL का निर्माण तब किया जाएगा जब यह पूरा हो जाएगा। मैं कोई तारीख नहीं बता सकता। मैं कुछ ऐसा पोस्ट नहीं करना चाहता जो बग से भरा हो।  
>   
...
Sir thanks very much till than I will be using phase 1 and can you give like rough estimate iam very excited
...
I want to read in pdf Hindi Urdu are they available
...
I have tried phase 2 but sir my nook stuck in splash screen not turning I removed the sd card and after connecting with the charger its battery was significantly drop from 88 to 47 percent and after putting at charge holding powe button multiple times it turned on i'am worried which build should I download [@nmyshkin](https://xdaforums.com/m/5562185/)

#### nmyshkin

##### Recognized Contributor

> [hassanraza100 said:](https://xdaforums.com/goto/post?id=90081907)
> 
> I have tried phase 2 but sir my nook stuck in splash screen not turning I removed the sd card and after connecting with the charger its battery was significantly drop from 88 to 47 percent and after putting at charge holding powe button multiple times it turned on i'am worried which build should I download [@nmyshkin](https://xdaforums.com/m/5562185/)
> 
> Click to expand...
...
The size of the sdcard should not matter as long as CWM boots up.  
  
Your battery may be dying and/or you may have some kind of hardware problem, but freezing at the splash screen during boot could be either a hardware problem or a bad flash. Or both.  
  
So there is a potential "hardware problem" twice.

#### hassanraza100

##### Member

> [nmyshkin said:](https://xdaforums.com/goto/post?id=90082160)
> 
> The size of the sdcard should not matter as long as CWM boots up.  
>   
> Your battery may be dying and/or you may have some kind of hardware problem, but freezing at the splash screen during boot could be either a hardware problem or a bad flash. Or both.  
...
thanks i just hold power button it turned on i successfully i installed phase 3 i have noticed when i put my sd card than nook starts freezing but lets hope it does not happen again. by the way thanks man i must have troubled you good luck for your next project eagerly waiting

#### nmyshkin

##### Recognized Contributor

> [hassanraza100 said:](https://xdaforums.com/goto/post?id=90084559)
> 
> In between I removed the ad SD card was. That my mistake for how much time should I press because press for 1 minute nothing happen just left it out is it good I thought when battery dies I will charge tries [@nmyshkin](https://xdaforums.com/m/5562185/)
> 
> Click to expand...
> 
> Click to collapse

Removing the card is not a good idea. In the instructions it states that CWM may hang on the splash screen, and if it does you should press the lower right hardware button. Once. Not for 1 minute.  
  
Anyway, if it freezes it is better to force a reboot with the power button. Removing the card during a freeze might damage it.

#### hassanraza100

##### Member

> [nmyshkin said:](https://xdaforums.com/goto/post?id=90084601)
> 
> Removing the card is not a good idea. In the instructions it states that CWM may hang on the splash screen, and if it does you should press the lower right hardware button. Once. Not for 1 minute.  
>   
> Anyway, if it freezes it is better to force a reboot with the power button. Removing the card during a freeze might damage
> 
> Click to expand...
> 
> Click to collapse

I removed it bro is it damaged and I plug it back 6 hours ago should I check tomorrow

#### nmyshkin

##### Recognized Contributor

> [hassanraza100 said:](https://xdaforums.com/goto/post?id=90094895)
> 
> dear [@nmyshkin](https://xdaforums.com/m/5562185/) i wanted to ask that does phase 3 consumer more battery than phase 1 as of my experiment its same it took 1 week battery now at 83 on phase 3. i have installed phase 3 i dont like alreader can you tell is it good i dont know how to change pages in it and how to highlight can i change with cool reader mistakenly deleted reading now how to restore
> 
> Click to expand...
> 
> Click to collapse

Battery sounds about right after a week. Phase 1 should be a little better, maybe 87-89%, but you lose all the custom stuff for better PDF, etc.  
  
All the reader apps are different. Many people like AlReader, but it does have a lot of different settings. To change pages, tap on the screen at the left or right edge. I did not set up buttons except for the two top ones (Back and Menu) because people have their own ideas of what is best.  
  
To highlight a word (to look up in a dictionary), long-press on the word.  
  
To use Cool Reader instead you need to flash that build. Otherwise the various custom features will not work properly.  
  
If you deleted the book cover image under "now reading" there is no simple way to get it back without new custom software because the device stores information about it which cannot be reset. The only solution is to re-flash.  
  
To prevent this kind of thing in the future, you might want to lock the desktop. You can do that from the home screen. Tap the status bar "menu" button and select "lock desktop" from the popup.

#### hassanraza100

##### Member

> [nmyshkin said:](https://xdaforums.com/goto/post?id=90094937)
> 
> Battery sounds about right after a week. Phase 1 should be a little better, maybe 87-89%, but you lose all the custom stuff for better PDF, etc.  
>   
> All the reader apps are different. Many people like AlReader, but it does have a lot of different settings. To change pages, tap on the screen at the left or right edge. I did not set up buttons except for the two top ones (Back and Menu) because people have their own ideas of what is best.  
...
I tried phase 1 simply going than this happens now stuck here what to do tried pressing poer button have not done anything not even removed as card what to do

#### Attachments

- [![17470753264111441547461446781814.jpg](https://xdaforums.com/data/attachments/4714/4714003-1b29efe58403a1bb5e0ab27b58f98f4d.jpg)](https://xdaforums.com/attachments/17470753264111441547461446781814-jpg.6227544/)
	17470753264111441547461446781814.jpg
	1,000.8 KB · Views: 7
...
> [hassanraza100 said:](https://xdaforums.com/goto/post?id=90095074)
> 
> I tried phase 1 simply going than this happens now stuck here what to do tried pressing poer button have not done anything not even removed as card what to do
> 
> Click to expand...
...
The instructions say that if CWM freezes (after each wipe or restore) you should hold the power button for a count of 10, then release for a count of 10, and repeat that until it reboots.  
  
That's the only way unless you have ADB set up which you probably do not.
