...
source: "https://xdaforums.com/t/nst-g-the-phoenix-project.4673934/page-3"
author:
  - "[[nmyshkin]]"
...
> [whatever\_green said:](https://xdaforums.com/goto/post?id=89634844)
> 
> Hi! ive just installed the [NST-US-newUI-AlR115](https://www.mediafire.com/file/m7sab0eu0b4ogxd/NST-US-newUI-AlR115.zip/file) version on my nook glowlight and it all successfully installed however, the file manager is unable to show files on my SDCard ive inserted. The sd is detected by the nook and it shows in the settings however the Format button is greyed out also.
> 
> Click to expand...
> 
> Click to collapse

Before I take a deep dive into this, can you confirm that you installed the version shown above on a Glowlight? There is a separate version for that....

#### whatever\_green

##### New member

Yes i did install the glowlight version, i accidently linked the wrong version sorry

#### srimanthacar

##### New member

> [nmyshkin said:](https://xdaforums.com/goto/post?id=89634882)
> 
> OK, I did a complete download of the posted file, and restore of the CWM backup on my NSTG. Everything went as expected, so.........?
> 
> Click to expand...
> 
> Click to collapse

Thank you nmyshkin, for your quick replies.  
Your above original post was a great resource for me to rescue my Nook.  
  
\*\*if possible can you please guide me on my next step\*\*  
My next step is to use the built-in Google Calendar, and use nook as a calendar display in my home.  
unfortunately, I couldn't log in to Google Calendar. the purpose is to display a personal Google calendar on nook fullscreen.  
so when calender updated from phone/pc it should show.  
  
My guess was since Nook runs on Android 2+ version this project will be easier. nook has internet, and can use the browser, but the calendar says it can't log in.  
...
> [srimanthacar said:](https://xdaforums.com/goto/post?id=89635215)
> 
> Thank you nmyshkin, for your quick replies.  
> Your above original post was a great resource for me to rescue my Nook.  
>   
...
I'm afraid you're more than a day late and a dollar short. Google has not allowed logins to its services (except in some limited cases via a web browser) for Android versions below 3.0 for a number of years now.  
  
People have done things like you describe, but only by using a local PC as an intermediate server, so the login is from the PC and then the data is massaged into a useful form and pushed to the NST. A lot of programming involved.  
  
It used to be possible to sign in to Google with Opera Mini and from there view a stripped-down version of your calendar. I haven't tried it for a few years, but even if it does work I don't think it's what you're after.  
  
Edit: and anyway, the calendar format has changed. Any calendar app you could find to run on the NST would not be using the correct data format

#### Intop

##### Member

**At first thanks for this super thread!!**  
  
I have the same problem with my NST. Hard reset to reconfigure for other user and PUM... problems. With the bypass (skipped OOBE) show a dramatic difference in battery charge life and need other option.  
  
Only have one question at this moment. This is all new for me.  
  
At first I view need to " **Make a CWM card"** but... viewing all the instructions... is for Windows. At this moment not have any Windows machine and working in my day with Mac.  
Have any possibility to do this first part in MACOS system? Any link or other thread to make a CWM card in Mac?

#### nmyshkin

##### Recognized Contributor

> [Intop said:](https://xdaforums.com/goto/post?id=89642989)
> 
> **At first thanks for this super thread!!**  
>   
> I have the same problem with my NST. Hard reset to reconfigure for other user and PUM... problems. With the bypass (skipped OOBE) show a dramatic difference in battery charge life and need other option.  
...
Unfortunately what I don't know about Macs would fill several Terabytes of hard drive space. I can only tell you what I've seen in other threads with disk images to burn: "Mac and Linux users can use dd."  
  
If that doesn't mean anything to you, then I have not helped at all. I do know that there is a dd for Windows and it is a command line utility which enables the creation of disk images (and probably their writing as well--I'm a "need to know" kind of user...).  
  
I think Macs have a DiskUtility? Maybe something there.....?  
  
I don't want to lead you astray and have you write the CWM image to your hard drive by mistake! Maybe you have a friend with a Windows machine who could help you with this task?

Last edited:

Reactions:[Intop](https://xdaforums.com/posts/89643143/reactions)

#### Intop

##### Member

> [nmyshkin said:](https://xdaforums.com/goto/post?id=89643143)
> 
> Unfortunately what I don't know about Macs would fill several Terabytes of hard drive space. I can only tell you what I've seen in other threads with disk images to burn: "Mac and Linux users can use dd."  
>   
> If that doesn't mean anything to you, then I have not helped at all. I do know that there is a dd for Windows and it is a command line utility which enables the creation of disk images (and probably their writing as well--I'm a "need to know" kind of user...).  
...
> I think Macs have a DiskUtility? Maybe something there.....?  
>   
> I don't want to lead to astray and have you write the CWM image to your hard drive by mistake! Maybe you have a friend with a Windows machine who could help you with this task?
> 
> Click to expand...
> 
> Click to collapse

Thanks for the "dd" tip!  
  
Maybe this instructions working.  

[Creating a Mac OS X Recovery SD Card - Robert Sesek](https://robert.sesek.com/2015/12/creating_a_mac_os_x_recovery_sd_card.html)

### How to write an image file to an SD card under Mac OS X (for Raspberry Pi)

How to write an image file to an SD card under Mac OS X (for Raspberry Pi) - gist:3139365

gist.github.com

  
Testing in some days if no any user have other idea to create CWM image via MacOx.  
  
UPDATE: WORKING WITH THIS COMMAND IN MAC VIA TERMINAL  
  
diskutil list  
diskutil unmountDisk /dev/sdcard  
sudo dd if=sdcard of=name of image  
sudo diskutil eject /dev/sdcard  
  
All the info in this link:  
![thepihut.com](https://xdaforums.com/proxy.php?image=http%3A%2F%2Fthepihut.com%2Fcdn%2Fshop%2Farticles%2Fsdbackup1_grande_8b0be458-2e00-456e-bbf6-ff292a2b09f7.png%3Fv%3D1540907485%26width%3D2048&hash=ff31427a82bbd8e30ec95ff00a913a68&return_error=1)

### Backing up and Restoring your Raspberry Pi's SD Card

As with all computers, it is a good idea to back up your Raspberry Pi's SD (or microSD) card from time to time; I'm just going to call them 'SD cards' from here on. This is especially true when you first get a pre-installed card from a retailer or friend. You will need a second computer, or a...

thepihut.com

Last edited:

Reactions:[nmyshkin](https://xdaforums.com/posts/89643771/reactions)
...
My 96 year old mum had worn out the bezel on her Glowlight, after 12 years of reading!  
I got her another from fleabay and have successfully registered it using the standard UK files from your Stage One.  
  
Then, as I already had the CWM image on the SD, I very quickly managed to register and update a spare NST (with a slightly dodgy USB) that was in the loft.  
  
My own NSTG was registered and updated several years ago, so I'm not touching that.  
  
My OH, who uses an elderly Kobo, has said that he would like a Glowlight. I'm now confident that, if I acquire another NSTG, I will be able to update and register it.

Reactions:[nmyshkin](https://xdaforums.com/posts/89746126/reactions)
...
Hi,  
Is it possible to run the original library application (phase 3)?

#### nmyshkin

##### Recognized Contributor

> [fperez76 said:](https://xdaforums.com/goto/post?id=89790139)
> 
> Hi,  
> Is it possible to run the original library application (phase 3)?
> 
...
Maybe. I've done some experimenting with another user who wanted FW 1.1.5 AND the stock reader. I think I've got something that will give decent battery life. It should work with FW 1.2.2 as well.  
  
Which build in phase 3 are you thinking about?  
  
Edit: but.....this will require some changes in the UI apps to accommodate the added reader option, so if you just want to add the stock reader it might be easier to go back to phase 2 and add an additional third-party reader there (someone has already done this with FBReader), unless you want either AlReader or CoolReader which really need FW 1.1.5

#### fperez76

##### Member

> [nmyshkin said:](https://xdaforums.com/goto/post?id=89790155)
> 
> Maybe. I've done some experimenting with another user who wanted FW 1.1.5 AND the stock reader. I think I've got something that will give decent battery life. It should work with FW 1.2.2 as well.  
>   
> Which build in phase 3 are you thinking about?  
...
This is the build [NST-US-newUI-CR115.zip](https://www.mediafire.com/file/hred14nka0zlonb/NST-US-newUI-CR115.zip/file). Would it be possible to install the original Nook library in this build via CWM?I don't want the reader, just the stock library to open the book with Coolreader but selecting the book cover from here.

#### Attachments

- [![images.jpeg](https://xdaforums.com/data/attachments/4648/4648392-5c77f00f17b34efd07778df26f88b803.jpg)](https://xdaforums.com/attachments/images-jpeg.6161924/)
	images.jpeg
	7.3 KB · Views: 117
...
> [fperez76 said:](https://xdaforums.com/goto/post?id=89790173)
> 
> This is the build [NST-US-newUI-CR115.zip](https://www.mediafire.com/file/hred14nka0zlonb/NST-US-newUI-CR115.zip/file). Would it be possible to install the original Nook library in this build via CWM?I don't want the reader, just the stock library to open the book with Coolreader but selecting the book cover from here.
> 
> Click to expand...
...
Well...maybe. I'm not sure how many dependencies the Library app may have (probably many). So what you'd really like to do is replace the "CR Library" app with the B&N stock Library app, is that about it?  
  
Probably you would need most if not all of the B&N reader/library suite and then you would just ignore the stock reader (i.e., you would assign CoolReader as the default reader for epubs). There are questions remaining. Let me play around a little with that build, adding back some of the B&N components and see what happens.

#### fperez76

##### Member

> [nmyshkin said:](https://xdaforums.com/goto/post?id=89790242)
> 
> Oh.  
>   
> Well...maybe. I'm not sure how many dependencies the Library app may have (probably many). So what you'd really like to do is replace the "CR Library" app with the B&N stock Library app, is that about it?  
...
Yes, that is. I prefer B&N stock Lybrary app instead of CR Library app or any other.

#### nmyshkin

##### Recognized Contributor

> [fperez76 said:](https://xdaforums.com/goto/post?id=89790253)
> 
> Yes, that is. I prefer B&N stock Lybrary app instead of CR Library app or any other.
> 
> Click to expand...
...
OK, just to let you know what I have so far. I got lucky in that there are no UI control elements in CR Library, so removing it did no harm.  
  
The B&N Library app works seamlessly with Cool Reader and the UI elements.  
  
So the not-so-good news is that the Reader app seems to be needed (but can be ignored, obviously) and the system wants to create "My Files" folders (can hide with ES File Explorer) and also generates thumbnails in.docThumbs (which you would have to delete manually).  
  
I may be able to trim down some of the system apps I restored to get to this point, but most of my efforts so far have resulted in a loss of cover images in the Library app. If you do not use that view then I will go with that assumption.  
  
I also want to let it sit for a day or two and see what happens to the battery charge.

#### fperez76

##### Member

> [nmyshkin said:](https://xdaforums.com/goto/post?id=89790611)
> 
> OK, just to let you know what I have so far. I got lucky in that there are no UI control elements in CR Library, so removing it did no harm.  
>   
> The B&N Library app works seamlessly with Cool Reader and the UI elements.  
...
Ok, but For me it is not a problem if you have to leave some system applications to correctly display the library with the covers.

Reactions:[nmyshkin](https://xdaforums.com/posts/89791518/reactions)

#### nmyshkin

##### Recognized Contributor

> [fperez76 said:](https://xdaforums.com/goto/post?id=89791518)
> 
> Ok, but For me it is not a problem if you have to leave some system applications to correctly display the library with the covers.
> 
> Click to expand...
...
I think I've got it, with essentially no background "chatter". Power consumption appears to be "normal" for these builds. Here we go:  
  
1\. Download the four system apps: AFileDownloadService.apk, GlobalSearch.apk, Library.apk and MediaProvider.apk. Transfer to /sdcard and move to /system/app on your device. Check that the permission of each app is rw-r-r.  
2\. Download the two jars: bncloudapi.jar and com.bn.cloud.jar. Transfer to /sdcard and move to /system/framework on your device. Check that the permission of each jar is rw-r-r.  
3\. Reboot.  
4\. First boot is slow because new apps and jars are discovered.  
5\. Uninstall "CR Library" app.  
6\. In app drawer open Simi Folder app. If you want to assign another icon to the Library app (like the Cool Reader icon, as an example), select the "Applications" button. Find "Library" in the listing and tap on it. Select the left-most button, "Change icon". Select "Default app icons" and find "Cool Reader". Tap that and back out until you are on the initial screen again.  
  
To replace the uninstalled "CR Library" in the Simi Folder with the Library app, tap on "Folders", then "Readers". Tap on "Add", then "Application". Find "Library" and check it. Then tap on "Save" at the top.  
  
This sends you back to the folder contents where "Library" will be at the bottom of the list. To restore to the top or first position, tap on "Sorting", and then "Custom". You can drag the apps around to get the list the way you want it, then tap on "OK". Use the back arrows/button to exit the app. The Library app will now appear in the "Readers" Simi Folder on the lower part of the home screen.  
  
Alternatively, if you don't use/have uninstalled the other readers and you'd like the "books" icon in the dock to take you directly to the Library, you can follow the example in the User Guide which is given for making the "world" icon go directly to Opera Mini.  
  
Double-tap in the Library will not work (requires Shops and other components), but that really does not matter since it only showed meta information for B&N books.  
  
Some things to keep in mind about the stock Library app:  
  
1\. It will find ALL epubs and pdfs in either /media or /sdcard. If you have some pdfs that you read with either EBookDroid or Perfect Viewer, you can hide them from the Library by creating a.nomedia file in the folder. This will not prevent other reader apps from seeing the files.  
2\. You may be challenged the first time you use either the "reading now" button or the book cover widget to access a book. It might be necessary to set a default for Cool Reader as the epub handler.  
3\. The Library app/media handler is not good at detecting new content unless it was copied over using the default USB method. If you copy over via FTP, for example, you need to copy the books to, perhaps, /sdcard/Download and then move them to the target folder. The Library app will detect this.  
4\. Books with very large cover images may not display properly in the Library. I don't know what the limit is, but generally you don't want to go much over 800x600. Either Calibre or Sigil can be used to adjust cover image sizes.  
5\. The Library app may create "My Files" folders in /media and /sdcard. If you delete them it will just replace them. You can "hide" these folders with ES File Explorer.  
6\. The Library app will create an ".adobe-digital-editions" folder in /media. You can "hide" this with ES File Explorer.  
7\. The Library app will create a ".docThumbs" folder in /sdcard (also /media, if you place epubs there) and store cover images there. These are not used in the UI. You will have to periodically clean out this folder.  
8\. the Library app does not close when you select a book. So if you exit Cool Reader through its menu option you will be returned to the Library. If you exit Cool Reader with the "n" button, both it and the Library will move to the background where the system will eventually kill them.  
9\. The Library app will only display epub or pdf books. It won't display other formats that Cool Reader might be able to read (mobi, azw, etc.).

#### fperez76

##### Member

> [nmyshkin said:](https://xdaforums.com/goto/post?id=89793163)
> 
> I think I've got it, with essentially no background "chatter". Power consumption appears to be "normal" for these builds. Here we go:  
>   
> 1\. Download the four system apps: AFileDownloadService.apk, GlobalSearch.apk, Library.apk and MediaProvider.apk. Transfer to /sdcard and move to /system/app on your device. Check that the permission of each app is rw-r-r.  
