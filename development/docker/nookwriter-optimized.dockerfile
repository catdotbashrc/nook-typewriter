...
# Copy minimal config
COPY runtime/configs/vim/vimrc-minimal /root/.vimrc
COPY runtime/configs/vim/eink.vim /root/.vim/colors/eink.vim
...
# Copy writer config
COPY runtime/configs/vim/vimrc-writer /root/.vimrc
COPY runtime/configs/vim/eink.vim /root/.vim/colors/eink.vim
...
COPY runtime/scripts/ /usr/local/bin/
...
COPY runtime/scripts/services/jester-daemon.sh /usr/local/bin/
COPY runtime/scripts/menu/nook-menu.sh /usr/local/bin/
COPY runtime/scripts/boot/boot-jester.sh /usr/local/bin/
