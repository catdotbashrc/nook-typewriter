...
# Source files
KERNEL_IMAGE="${PROJECT_ROOT}/platform/nook-touch/boot/uImage"
MLO_FILE="${PROJECT_ROOT}/platform/nook-touch/boot/MLO"
UBOOT_FILE="${PROJECT_ROOT}/platform/nook-touch/boot/u-boot.bin"
BOOT_SCRIPT="${PROJECT_ROOT}/platform/nook-touch/boot/boot.scr"
