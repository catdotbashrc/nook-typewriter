...
if [ -f "platform/nook-touch/boot/uImage" ]; then
    cp platform/nook-touch/boot/uImage "$CWM_DIR/boot/"
...
if ls platform/nook-touch/modules/*.ko 2>/dev/null; then
    cp platform/nook-touch/modules/*.ko "$CWM_DIR/system/lib/modules/2.6.29/"
    echo "  [OK] Kernel modules (.ko) added"
elif ls platform/nook-touch/modules/*.o 2>/dev/null; then
    # For now, copy .o files as placeholders
    cp platform/nook-touch/modules/*.o "$CWM_DIR/system/lib/modules/2.6.29/"
