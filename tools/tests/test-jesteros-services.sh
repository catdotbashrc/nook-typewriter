...
cp -r /home/jyeary/projects/personal/nook/src/services/configs/services/* "$SERVICE_CONFIG_DIR/"

# Update service configs to use test paths
sed -i "s|/usr/local/bin/jester-daemon.sh|/home/jyeary/projects/personal/nook/src/services/jester/jester-daemon.sh|g" "$SERVICE_CONFIG_DIR"/*.conf
sed -i "s|/usr/local/bin/jesteros-tracker.sh|/home/jyeary/projects/personal/nook/src/services/jester/jesteros-tracker.sh|g" "$SERVICE_CONFIG_DIR"/*.conf
sed -i "s|/usr/local/bin/health-check.sh|/home/jyeary/projects/personal/nook/src/services/jester/health-check.sh|g" "$SERVICE_CONFIG_DIR"/*.conf
...
for service in "${services[@]}"; do
    service_path="/home/jyeary/projects/personal/nook/src/services/jester/$service"
...
if HEALTH_CHECK_INTERVAL=1 /home/jyeary/projects/personal/nook/src/services/jester/health-check.sh check >/dev/null 2>&1; then
...
if timeout 5 /home/jyeary/projects/personal/nook/src/services/jester/daemon.sh status >/dev/null 2>&1; then
...
if timeout 5 /home/jyeary/projects/personal/nook/src/services/jester/tracker.sh status >/dev/null 2>&1; then
...
manager_script="/home/jyeary/projects/personal/nook/src/services/jester/manager.sh"
...
key_files=(
    ...
    "/home/jyeary/projects/personal/nook/src/services/jester/daemon.sh"
    "/home/jyeary/projects/personal/nook/src/services/jester/tracker.sh"
    "/home/jyeary/projects/personal/nook/src/services/jester/health-check.sh"
    "/home/jyeary/projects/personal/nook/src/services/jester/manager.sh"
)
